...
list_suppliers_fr = list(set(['EDF', 'Eni', 'ENGIE', 'Gaz Europeen', 'Sowee', 'Dyneff', 'Ekwateur', 'Mega Energie', 'Total Energies', 'other']))
list_suppliers_es = list(set(['Endesa', 'Iberdrola', 'Holaluz', 'Fenie', 'Energia XXI', 'Naturgy', 'Total Energies', 'Alcanzia', 'Aldoro', 'Audax', 'Bonpreu Esclat', 'Catllum', 'DRK Energia', 'EDP', 'Energy GO', 'FC Energia', 'Gana Energia', 'Gesternova', 'Nabalia', 'Podo', 'Repsol', 'Solelec', 'Somenergia', 'Catgas', 'Gas Natural Fenosa', 'Emivasa', 'other']))
list_suppliers_it = list(set(['Enel', 'Plenitude', 'A2A', 'Repower', 'Iren', 'Acea Energia', 'Sorgenia', 'Gas Sales Energia', 'Wekiwi', 'SEN', 'Edison', 'Hera Comm', 'Axpo', 'Metaenergia', 'Milano Gas e Luce']))
list_suppliers_all = list(set(list_suppliers_fr + list_suppliers_es + list_suppliers_it))
